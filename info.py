...
API_ID = int(environ.get('API_ID', '26094151'))
API_HASH = environ.get('API_HASH', 'fa7ad6998a59a82bb090a60d72c4e15f')
BOT_TOKEN = environ.get('BOT_TOKEN', "7980594247:AAGjMy5z1cuLgKN9A0xFbOd4pqGGbB21InQ")
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6948816939').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002676743329'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002562700934').split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://arousealain:181lokU5LC4Aln0i@cluster0.ieqhws8.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/arousebackup')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/arousebackup')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'arousebackup') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/arousebackup')
