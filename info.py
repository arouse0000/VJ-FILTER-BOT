...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002630923376'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002519278156 -1002027822471').split()]  # For Multiple Id Use One Space Between Each.
